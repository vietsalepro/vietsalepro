...
- [ ] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p12-2-email-templates_<YYYYMMDD_HHMMSS>`
...
- [ ] 1.1 Implement backend changes (RPC/migration/Edge Function) for P12 2 Email Templates
- [ ] 1.2 Implement frontend changes for P12 2 Email Templates
...
- [ ] P12.2 — Email templates + composer: logo, brand color, signature.
- [ ] `npm run lint` pass
- [ ] `npm run build` pass
