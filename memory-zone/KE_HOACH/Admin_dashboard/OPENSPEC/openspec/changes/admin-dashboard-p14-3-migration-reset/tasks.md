...
- [ ] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p14-3-migration-reset_<YYYYMMDD_HHMMSS>`
...
- [ ] 1.1 Implement backend changes (RPC/migration/Edge Function) for P14 3 Migration Reset
- [ ] 1.2 Implement frontend changes for P14 3 Migration Reset
