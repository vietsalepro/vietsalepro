-- Sub-Phase 6.1 follow-up (v2): fix the generic audit_log_trigger so it works for tables
-- that do not have a tenant_id column (e.g. public.tenants).
-- ponytail: the v1 COALESCE still referenced NEW.tenant_id at runtime, which errors for tenants.
