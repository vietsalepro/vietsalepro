# Sprint 04 - Input System File Creator
$baseDir = "e:\App ban hàng\vietsale-pro-v7"
...
'@
Set-Content -Path "$baseDir\components\TextInput.css" -Value $css1 -Encoding UTF8
Write-Host "TextInput.css created"
...
'@
Set-Content -Path "$baseDir\components\SelectInput.css" -Value $css2 -Encoding UTF8
Write-Host "SelectInput.css created"
...
'@
Set-Content -Path "$baseDir\components\FormField.css" -Value $css3 -Encoding UTF8
Write-Host "FormField.css created"

Write-Host "ALL CSS FILES CREATED SUCCESSFULLY"