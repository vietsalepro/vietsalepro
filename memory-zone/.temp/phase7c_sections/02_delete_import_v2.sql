-- =====================================================================
-- 2. XÃ³a phiáº¿u nháº­p â€” Ä‘áº£o Purchase Receipt
-- =====================================================================
...
BEGIN
  ...
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Phiáº¿u nháº­p % khÃ´ng tá»“n táº¡i trong há»‡ thá»‘ng', p_receipt_id;
  END IF;
  ...
  LOOP
    ...
    IF NOT v_allow_negative AND v_current_qty < v_item.quantity THEN
      RAISE EXCEPTION 'KhÃ´ng thá»ƒ xÃ³a phiáº¿u nháº­p %: Sáº£n pháº©m % Ä‘Ã£ bÃ¡n vÆ°á»£t quÃ¡ sá»‘ lÆ°á»£ng nháº­p (Tá»“n hiá»‡n táº¡i %, yÃªu cáº§u tráº£ %)',
    ...
    IF v_has_lots THEN
      ...
      IF NOT v_allow_negative AND (NOT FOUND OR v_existing_lot_qty < v_item.quantity) THEN
        RAISE EXCEPTION '%', format('KhÃ´ng thá»ƒ xÃ³a phiáº¿u nháº­p %: LÃ´ % cá»§a sáº£n pháº©m % khÃ´ng Ä‘á»§ tá»“n kho Ä‘á»ƒ giáº£m trá»« (LÃ´ hiá»‡n cÃ³ %, yÃªu cáº§u trá»« %)',
