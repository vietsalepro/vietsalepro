...
- Deployed Edge Function `system-health` to linked Supabase project `shbmzvfcenbybvyzclem`.
...
- [x] Edge Function responds `401 Missing authorization header` when called unauthenticated (deployment OK)
