...
- [x] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p14-2-restore-archive_20260708_094719`
...
- [x] 1.1 Implement backend changes (RPC/migration/Edge Function) for P14 2 Restore Archive
- [x] 1.2 Implement frontend changes for P14 2 Restore Archive
...
- [x] P14.2 — Per-tenant restore + archive tenant + import workflow.
- [x] `npm run lint` pass
