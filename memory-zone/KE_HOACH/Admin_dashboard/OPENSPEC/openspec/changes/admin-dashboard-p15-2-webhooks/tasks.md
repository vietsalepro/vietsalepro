...
- [ ] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p15-2-webhooks_<YYYYMMDD_HHMMSS>`
...
- [ ] 1.1 Implement backend changes (RPC/migration/Edge Function) for P15 2 Webhooks
- [ ] 1.2 Implement frontend changes for P15 2 Webhooks
...
- Backup: `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p15-2-webhooks_<YYYYMMDD_HHMMSS>`
