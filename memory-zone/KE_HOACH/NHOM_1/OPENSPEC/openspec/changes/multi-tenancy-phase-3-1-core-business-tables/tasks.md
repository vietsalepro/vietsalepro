...
- [ ] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_multi_tenancy_phase_3_1_<YYYYMMDD_HHMMSS>`
...
- [ ] 1.1 Run SQL migration to add `tenant_id` column, FK, and index for tables: `products`, `customers`, `orders`, `order_items`, `suppliers`, `promotions`
- [ ] 1.2 Thêm `tenant_id` vào interface của 6 bảng trong `types.ts`.
