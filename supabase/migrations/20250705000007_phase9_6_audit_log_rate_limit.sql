-- Phase 9.6: Edge Function `audit-log` + rate limiting
-- Mục tiêu: Cung cấp bảng rate limiting và audit log để function hoạt động.
-- ponytail: tạo idempotent; Phase 9.1 đã tạo cùng schema nên chạy lại không lỗi.
...
-- ============================================================
-- 2. Audit log table (đã tạo ở Phase 9.1, đảm bảo tồn tại)
-- ============================================================
