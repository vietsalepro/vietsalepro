...
- [ ] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p9-1-billing-reminders_<YYYYMMDD_HHMMSS>`
...
- [ ] 1.1 Implement backend changes (RPC/migration/Edge Function) for P9 1 Billing Reminders
- [ ] 1.2 Implement frontend changes for P9 1 Billing Reminders
...
- [ ] P9.1 — Billing reminder schedule (T-7/T-3/T-1) + email templates.
- [ ] `npm run lint` pass
- [ ] `npm run build` pass
