...
- [x] 0.1 Create project backup to `C:\Users\SUACAUBA\Downloads\Project\vietsale-pro-v7_backup_admin_dashboard_admin-dashboard-p13-1-system-health_<YYYYMMDD_HHMMSS>`
...
- [x] 1.1 Implement backend changes (RPC/migration/Edge Function) for P13 1 System Health
- [x] 1.2 Implement frontend changes for P13 1 System Health
...
- [x] P13.1 — System health dashboard: DB/storage/edge function status cards.
- [x] `npm run lint` pass
